...
inline "fwd" r"""// <generated by nc transpiler>
#include <iostream>
#include <memory>
#include <string>
using NCX_VOID = int;
...
inline "hdr" r"""struct NCXX_ZUpreludeZDObject {
...
inline "src" r"""NCX_STRING NCX_mkstr(const char *s) {
